...
- 独立“模型设置”页可切换已验证的报告大模型，默认内置 5 个国产和 2 个国外候选模型；Qwen3-8B 与 DeepSeek-R1-Distill-Qwen-7B 已通过端到端报告结构校验
...
git checkout cloud-server-v1.1.8
```
...
```text
稳定演示/复现实验：使用 cloud-server-v1.1.8
日常继续开发：使用 main
```
